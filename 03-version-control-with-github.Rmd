...
AVOCADO: 1. Following the instructions, I sometimes got confused about when to use GitHub and when to use GitKraken. It was mentioned on the document, so I believe people could locate/understand it, but maybe it could be clearer if it could be stated in each section/paragraph or have direct cues such as “Let’s move on to GitKraken to clone the local repository”. “We can use GitKraken to perform these tasks ABC.”
...
```
AVOCADO: this image needs to be confirmed.
