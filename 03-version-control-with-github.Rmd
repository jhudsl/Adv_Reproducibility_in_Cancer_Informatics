...
Now we can edit our files and code however we normally would. Make an edit to any file in your new repository.
...
We can check out the file changes while in GitKraken.
...
Now that we have changes committed to our branch we are ready to also add them to the remote, internet copy!
