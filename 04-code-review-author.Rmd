...
```{r, fig.alt="This chapter will demonstrate how to: Understand the goals and motivation of code review. Solicit feedback in the context of code review. Incorporate feedback in the context of code review.", out.width = "100%", echo = FALSE}
leanbuild::include_slide("https://docs.google.com/presentation/d/1IJ_uFxJud7OdIAr6p8ZOzvYs-SGDqa7g4cUHtUld03I/edit#slide=id.gfa93c34783_0_0")
```
...
An effective code review atmosphere is something that individuals and their team have to commit to (pun intended). Effective code review and a great team atmosphere around it brings so many benefits not only to your project quality but also your communication skills, and individual skill building!

In this chapter and the next we will discuss the two sides of code review Code review ideally includes at least two people: the author of the pull request and the reviewer of the pull request. Although depending on your job context, we realize that sometimes authors have to become their own reviewers if code review is not something prioritized by your institution or team.

## Author responsibilities in code review

The code review process begins with the creation pull request. Successful and efficient code review is born out of quality communication, which is a skill set on its own. You can set up your reviewers (and yourself) up for success by knowing what basic information can help get the code review conversation going.
...
leanbuild::include_slide("https://docs.google.com/presentation/d/1IJ_uFxJud7OdIAr6p8ZOzvYs-SGDqa7g4cUHtUld03I/edit#slide=id.gfc3e8b194d_0_46")
```
...
### have an explicit request for what kind of feedback is needed
...
The first reviewer of your code should always be yourself! Take time to review your own changes by clicking on the `Files Changed` tab and going over that section carefully.
...
Additional tip, if you don't want others to look at your pull request yet because you are still working on reviewing it, you can change it to [a draft pull request](https://github.blog/2019-02-14-introducing-draft-pull-requests/) so no one reviews it before you are ready.
...
leanbuild::include_slide("https://docs.google.com/presentation/d/1IJ_uFxJud7OdIAr6p8ZOzvYs-SGDqa7g4cUHtUld03I/edit#slide=id.gfa97af8537_0_8")
```
...
leanbuild::include_slide("https://docs.google.com/presentation/d/1IJ_uFxJud7OdIAr6p8ZOzvYs-SGDqa7g4cUHtUld03I/edit#slide=id.gfc3e8b194d_0_118")
```
...
leanbuild::include_slide("https://docs.google.com/presentation/d/1IJ_uFxJud7OdIAr6p8ZOzvYs-SGDqa7g4cUHtUld03I/edit#slide=id.gfa97af8537_0_0")
```

#### Set up a pull request template

1. Create a new branch as we described in the previous chapter.
1. In your local repository, create a folder called `.github`
1. Download this [pull request template file](https://raw.githubusercontent.com/jhudsl/Adv_Reproducibility_in_Cancer_Informatics/main/resources/PULL_REQUEST_TEMPLATE.md) to get you started.
1. Feel free to edit this file to your own needs and add it to the `.github` folder.
1. Use GitKraken to `add` and `commit` this new file.
1. Push this commit.
1. Open up a pull request.
1. Craft your pull request description based on what we discussed in this chapter.
1. Click on the `Files Changed` tab and make sure it includes the `.github/PULL_REQUEST_TEMPLATE.md` file.
1. Walk away from your pull request and then return later and review it yourself.
1. Make any necessary changes.
1. When you are ready, [request a reviewer](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/requesting-a-pull-request-review) by choosing someone underneath `Reviewer` on the right side!
...
leanbuild::include_slide("https://docs.google.com/presentation/d/1IJ_uFxJud7OdIAr6p8ZOzvYs-SGDqa7g4cUHtUld03I/edit#slide=id.g102298f211a_0_49")
```

First of all, you should pat yourself on the back for engaging in code review! It does require more time and sometimes that can feel scary with looming deadlines, but you've prioritized your commitment to creating increasingly reproducibility analyses! You could have chosen to keep your code's problems buried under a rug, but you are putting your code out there and making your analyses transparent! Remember that hidden problems don't get solved, but known problems are opportunities for reaching an even better end result than you imagined!

Remember that you are not your code and mistakes are all a part of the process!
...
leanbuild::include_slide("https://docs.google.com/presentation/d/1IJ_uFxJud7OdIAr6p8ZOzvYs-SGDqa7g4cUHtUld03I/edit#slide=id.gfa97af8537_0_86")
```
