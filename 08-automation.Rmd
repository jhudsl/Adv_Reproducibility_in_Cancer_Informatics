...
Use a [GitHub Action Template by following these instructions](https://docs.github.com/en/actions/learn-github-actions/using-workflow-templates#using-workflow-templates)

You will need to navigate to your own repository to do this.

_Tips for developing a GitHub Action:_  

- As you are adding your GitHub actions, [consult the GitHub actions log](https://docs.github.com/en/actions/monitoring-and-troubleshooting-workflows/using-workflow-run-logs).
- [GitHub actions has pretty great documentation](https://docs.github.com/en/actions) so as you are setting up your GitHub actions template, you will want to reference them.
...
- For testing purposes, modify the trigger so you can test it. You may want to use a [manual workflow trigger](https://docs.github.com/en/actions/learn-github-actions/events-that-trigger-workflows#manual-events) or [`pull request:` and `push:`](https://docs.github.com/en/actions/learn-github-actions/events-that-trigger-workflows#push).
