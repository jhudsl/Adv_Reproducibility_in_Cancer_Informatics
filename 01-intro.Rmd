...
This course is meant to have learners become further familiar with reproducibility tools. It does not necessarily represent the absolute end-all, be-all best practices for the use of these tools, but instead . In other words, this course gives a starting point with these tools, but not an ending point.
...
leanbuild::include_slide("https://docs.google.com/presentation/d/1IJ_uFxJud7OdIAr6p8ZOzvYs-SGDqa7g4cUHtUld03I/edit#slide=id.gfc23e712f4_0_1")
```
