...
AVOCADO: 1. Following the instructions, I sometimes got confused about when to use GitHub and when to use GitKracken. It was mentioned on the document, so I believe people could locate/understand it, but maybe it could be clearer if it could be stated in each section/paragraph or have direct cues such as “Let’s move on to GitcKraken to clone the local repository”. “We can use GitKraken to perform these tasks ABC.”
AVOCADO: 2. I think the highlights with change in font (coding font?) really makes it clearer. It might be helpful to also highlight, or just add a different color, (e.g. blue) to underscore terminologies like pull requests when they appear in the course for the first time.
AVOCADO: 3. I really like how the course really reads like spoken English, which makes it easier for me to understand. I don’t think the sentences have to be 100% grammatically correct, because this might make the writing feel a little more distant. That being said, I edited some sentences that could use a little more clarity (e.g. run-ons, etc). 
...
ottrpal::include_slide("https://docs.google.com/presentation/d/1IJ_uFxJud7OdIAr6p8ZOzvYs-SGDqa7g4cUHtUld03I/edit#slide=id.g1013f9881e2_0_132")
```
...
ottrpal::include_slide("https://docs.google.com/presentation/d/1IJ_uFxJud7OdIAr6p8ZOzvYs-SGDqa7g4cUHtUld03I/edit#slide=id.g101867ebdaa_18_0")
```
...
AVOCADO: I’m not sure how people use command line in a sentence – it seems more natural to me to insert “the”, but it might be said differently in the Data Science world?
...
AVOCADO: The link seems to be broken: does not show.
...
It is simple to clone a GitHub repository using GitKraken. First, sign in to GitKracken; under Repository Management > Clone tab, click `Clone a repo`. Then, choose where you’d like the repository to be on your computer using the `Browse` button. You will need to `Copy + Paste` your new repository's URL (web address) to  where it says `URL`.
...
Handling branches is where you unleash the real benefit of GitHub, but it's also the confusing part to get the hang of. A branch is a unique set, or copy, of codes and code changes.
AVOCADO: Please check the definition and see if this is accurate. I felt a definition would be helpful but am unsure if this description captures everything.
...
```
AVOCADO: In screenshot above - revise numbering (1, 2, 3; not 2, 3, 3)
...
AVOCADO: Please also review the definition of origin - I also searched this on Google and hope it is correct!
