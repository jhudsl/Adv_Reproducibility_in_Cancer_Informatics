...
This course is designed for busy professional learners -- who may have to pick up and put down the course as their schedule allows. In general, you are able to skip forward to chapters you find most useful (one incidence where a prior chapter is required is noted).
